...
class HistoryPageDesktop extends StatefulWidget {
  const HistoryPageDesktop({super.key});

  @override
  State<HistoryPageDesktop> createState() => _HistoryPageDesktopState();
}

class _HistoryPageDesktopState extends State<HistoryPageDesktop> {
      ...
      child: InkWell(
        ...
        child: LayoutBuilder(
          builder: (context, constraints) {
            final lineWidth = (constraints.maxWidth / 27).clamp(14.0, 72.0);
            return Padding(
